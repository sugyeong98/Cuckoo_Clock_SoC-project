                ...
                if(reset_p) begin
                        ...
                        if(clk_8msec_n)begin   //pdt 관리를 위해
                                if(row) begin
                                        key_valid =1;
                                        case({col, row})
                                             8'b0001_0001 : key_value = 7'd50;
                                             8'b0001_0010 : key_value = 7'd35;
                                             8'b0001_0100 : key_value = 7'd20;
                                             8'b0001_1000 : key_value = 7'd65;
                                             8'b0010_0001 : key_value = 7'd55;
                                             8'b0010_0010 : key_value = 7'd40;
                                             8'b0010_0100 : key_value = 7'd25;
                                             8'b0010_1000 : key_value = 7'd15;
                                             8'b0100_0001 : key_value = 7'd60;
                                             8'b0100_0010 : key_value = 7'd45;
                                             8'b0100_0100 : key_value = 7'd30;
                                             8'b0100_1000 : key_value = 7'd70;
                                             8'b1000_0001 : key_value = 7'd75;
                                             8'b1000_0010 : key_value = 7'd15;
                                             8'b1000_0100 : key_value = 7'd45;
                                             8'b1000_1000 : key_value = 7'd75;       
                                       endcase     
                                 end
                                 else begin
