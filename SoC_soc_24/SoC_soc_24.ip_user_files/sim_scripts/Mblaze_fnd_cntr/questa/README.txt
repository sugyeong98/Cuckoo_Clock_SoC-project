...
#
# Generated by export_simulation on Thu Oct 24 13:54:58 +0900 2024
#
################################################################################
...
'-reset_run' switch to the './Mblaze_fnd_cntr.sh' script.

./Mblaze_fnd_cntr.sh -reset_run
...
./Mblaze_fnd_cntr.sh -noclean_files

For more information on the script, please type './Mblaze_fnd_cntr.sh -help'.
