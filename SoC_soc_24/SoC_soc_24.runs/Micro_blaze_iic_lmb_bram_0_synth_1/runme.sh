...
HD_PWD='C:/Users/SUJIN/Desktop/sg_workspace/SoC_soc_24/SoC_soc_24.runs/Micro_blaze_iic_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Micro_blaze_iic_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Micro_blaze_iic_lmb_bram_0.tcl
