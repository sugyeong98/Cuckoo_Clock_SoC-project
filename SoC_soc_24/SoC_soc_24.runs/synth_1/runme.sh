...
HD_PWD='C:/Users/hama5/Desktop/sg_workspace/SoC_soc_24/SoC_soc_24.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Remo_cuckoo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Remo_cuckoo_wrapper.tcl
