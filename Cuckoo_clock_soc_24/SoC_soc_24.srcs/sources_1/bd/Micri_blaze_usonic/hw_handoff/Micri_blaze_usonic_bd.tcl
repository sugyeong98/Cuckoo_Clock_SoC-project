...
################################################################
# This is a generated script based on design: Micri_blaze_usonic
#
...
# source Micri_blaze_usonic_script.tcl
...
set design_name Micri_blaze_usonic
...
proc create_root_design { parentCell } {
  ...
  set led_debug_0 [ create_bd_port -dir O -from 15 -to 0 led_debug_0 ]
  ...
  # Create instance: myip_usonic_0, and set properties
  set myip_usonic_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:myip_usonic:1.0 myip_usonic_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI] [get_bd_intf_pins myip_usonic_0/S00_AXI]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs myip_usonic_0/S00_AXI/S00_AXI_reg] -force
