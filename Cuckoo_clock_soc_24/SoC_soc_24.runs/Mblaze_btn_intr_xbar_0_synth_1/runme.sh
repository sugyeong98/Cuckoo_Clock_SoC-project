...
HD_PWD='C:/Users/SUJIN/Desktop/sg_workspace/SoC_soc_24/SoC_soc_24.runs/Mblaze_btn_intr_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mblaze_btn_intr_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mblaze_btn_intr_xbar_0.tcl
