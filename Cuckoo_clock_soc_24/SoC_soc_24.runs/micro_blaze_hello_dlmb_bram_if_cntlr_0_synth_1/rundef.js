...
ISEStep( "vivado",
         "-log micro_blaze_hello_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source micro_blaze_hello_dlmb_bram_if_cntlr_0.tcl" );
