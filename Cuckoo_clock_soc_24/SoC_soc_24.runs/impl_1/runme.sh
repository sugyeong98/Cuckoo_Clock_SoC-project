...
HD_PWD='C:/Users/SUJIN/Desktop/sg_workspace/SoC_soc_24/SoC_soc_24.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Remo_cuckoo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Remo_cuckoo_wrapper.tcl -notrace
