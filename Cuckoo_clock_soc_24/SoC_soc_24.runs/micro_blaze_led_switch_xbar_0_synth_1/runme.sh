...
HD_PWD='C:/Users/PC/Desktop/SG_workspace/SoC_soc_24/SoC_soc_24.runs/micro_blaze_led_switch_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_blaze_led_switch_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source micro_blaze_led_switch_xbar_0.tcl
