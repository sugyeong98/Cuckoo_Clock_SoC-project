...
HD_PWD='C:/Users/PC/Desktop/SG_workspace/SoC_soc_24/SoC_soc_24.runs/Mblaze_fnd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mblaze_fnd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mblaze_fnd_xbar_0.tcl
